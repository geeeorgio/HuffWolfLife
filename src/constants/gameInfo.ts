...
export const ONBOARDING_INFO = {
  onboarding_1: {
    ...
    description: 'Explore the world through the eyes of a wolf',
  ...
  onboarding_2: {
    ...
    description: 'Make choices and see how a wolf survives in the wild',
  ...
  onboarding_3: {
    ...
    description: 'Daily life, instincts, and survival in nature',
  ...
  onboarding_4: {
    ...
    description: 'Answer questions and see how well you understand the wild',
  ...
  onboarding_5: {
    ...
    description: 'Step into the world of the wolf',
